...
<br>
  <!-- Page Header Start -->
  <div class="container-fluid page-header" style="height: 800px;">
    <h6 class="display-3 text-uppercase text-white mb-3">Log in </h6>
    <div class="container-fluid pb-5">
        <div class="container" id="registerationDiv">
                            ...
                            <center>
                                <div class="">
                                    <div class="col-xl-6 col-lg-6 col-md-6 form-group my-5">
                                        ...
                                        <input type="password" class="form-control p-4 my-3" placeholder="Enter Password" required="required">
                            ...
                            <div class="mb-5">
                                <div class="form-group">      
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-2 px-2">
                                        <button class="btn btn-primary btn-block mb-3" style="height: 50px;">LogIn</button>
                                    </div>
                                     </center>
                                </div>
                            </div>
